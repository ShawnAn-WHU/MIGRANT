...
if __name__ == "__main__":
    ...
    vis_dir = os.path.join(dataset_dir, f"vis_{args.suffix}")
    image_dir = os.path.join(dataset_dir, args.suffix)
    remove_image(image_dir, vis_dir)

    json_path = os.path.join(dataset_dir, f"label_{args.suffix}.json")
