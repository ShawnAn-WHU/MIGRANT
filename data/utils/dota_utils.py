# Copy from https://github.com/CAPTAIN-WHU/DOTA_devkit
import sys
import codecs
import numpy as np
...
def custombasename(fullname):
    ...
    base_name = os.path.basename(os.path.splitext(fullname)[0])
    return os.path.join(last_dir_name, base_name)
...
def parse_dota_rec(filename):
    ...
    for obj in objects:
        ...
        obj['bndbox'] = list(map(int, obj['bndbox']))
    return objects
